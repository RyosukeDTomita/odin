...
public enum IssueDefinition {
    ...
    CORS_WILDCARD_ORIGIN(
        ...
        AuditIssueSeverity.MEDIUM, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.HIGH
    ),
    CORS_CREDENTIALS_WITH_WILDCARD(
        ...
        AuditIssueSeverity.HIGH, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.HIGH
    ),
    CORS_REFLECTED_ORIGIN(
        ...
        AuditIssueSeverity.HIGH, AuditIssueConfidence.FIRM, AuditIssueSeverity.HIGH
    ),
    ...
    CORS_DANGEROUS_METHODS(
        ...
        AuditIssueSeverity.LOW, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.MEDIUM
    ),
    CORS_WILDCARD_HEADERS(
        ...
        AuditIssueSeverity.LOW, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.LOW
    ),
    ...
    COOKIE_MISSING_SECURE(
        ...
        AuditIssueSeverity.MEDIUM, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.MEDIUM
    ),
    ...
    COOKIE_SESSION_COOKIE(
        ...
        AuditIssueSeverity.INFORMATION, AuditIssueConfidence.CERTAIN, AuditIssueSeverity.INFORMATION
    ),
    COOKIE_BROAD_PATH(
    ...
    COOKIE_SAMESITE_NONE(
        ...
        AuditIssueSeverity.LOW, AuditIssueConfidence.FIRM, AuditIssueSeverity.LOW
    ),
    ...
    CSP_MISSING(
        ...
        AuditIssueSeverity.LOW, AuditIssueConfidence.TENTATIVE, AuditIssueSeverity.MEDIUM
    ),
    ...
    IssueDefinition(String name, String background, String remediation,
    ...
    public AuditIssueSeverity getSeverity()    { return severity; }
    public AuditIssueConfidence getConfidence(){ return confidence; }
    public AuditIssueSeverity getTypicalSeverity() { return typicalSeverity; }
}
